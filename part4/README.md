...
Part 4 of the HBnB project consists of creating a web front-end interface that communicates with the backend via a REST API. The interface allows users to browse places, log in, and leave reviews.
...
- Each card contains: name, price and "View Details" button
...
- Form with text field and rating (0-5)
...
3. The list of places **does not display** because you are not logged in
...
3. Log in and try again from a place page
...
2. If you receive a 401 error, log in again
